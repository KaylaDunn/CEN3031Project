...
func TestCommentOnPost(t *testing.T) {
	...
	//login first
	// test commenting post that was just created and is about to be deleted
	...
	data = map[string]interface{}{
		"comment": "oh wow, what a great post.",
	}
	...
	httpposturl = "http://0.0.0.0:3000/api/auth/comment/" + postID
	...
	got = string(body) == "{\"comment\":\"oh wow, what a great post.\",\"message\":\"Comment created successfully\",\"postID\":"+postID+"}"
	want = true
...
func TestCommentOnPostFail(t *testing.T) {
	...
	httpposturl = "http://0.0.0.0:3000/api/auth/comment/9999"
...
func TestCommentOnPostUnauthorized(t *testing.T) {
...
func TestGetPostsByLocation(t *testing.T) {
	...
	httpposturl := "http://0.0.0.0:3000/api/posts/location/palatka"
...
func TestGetPostsByLocationNoResults(t *testing.T) {
